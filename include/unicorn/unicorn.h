...
*/
UNICORN_EXPORT
uc_err uc_virtual_mem_write(uc_engine *uc, uint64_t address, const void *bytes, size_t size);
...
*/
UNICORN_EXPORT
uc_err uc_virtual_mem_read(uc_engine *uc, uint64_t address, void *bytes, size_t size);
